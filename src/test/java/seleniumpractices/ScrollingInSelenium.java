...
public class ScrollingInSelenium {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement bloglink = driver.findElement(By.xpath("//a[text()='Blogger']"));

		javascriptExecutor.executeScript("arguments[0].scrollIntoView();", bloglink);

		Thread.sleep(2000);

		javascriptExecutor.executeScript("arguments[0].click();", bloglink);
